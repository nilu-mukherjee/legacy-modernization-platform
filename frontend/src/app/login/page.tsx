      ...
      <div className="relative w-full max-w-md animate-[slide-up_0.5s_ease-out]">
        ...
        <div className="glass rounded-2xl p-8 glow-border">
          ...
          <form action={signInWithGitHub}>
            <button
              type="submit"
              className="group flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl bg-white px-6 py-3.5 text-base font-semibold text-gray-900 transition-all hover:bg-gray-100 hover:shadow-lg"
            >
