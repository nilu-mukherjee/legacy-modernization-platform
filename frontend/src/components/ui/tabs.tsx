/**
 * @fileoverview Tabs component using Radix UI Tab primitives.
 *
 * Provides `Tabs`, `TabsList`, `TabsTrigger`, and `TabsContent`
 * with dark-mode-first styling and animated active states.
 *
 * @example
 * ```tsx
...
/** Content panel revealed when its associated trigger is active. */
